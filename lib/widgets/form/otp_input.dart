...
import 'package:poke_book/utils/classess/otp_input_style.dart';
...
class AppOTPInput extends StatefulWidget {
  ...
  const AppOTPInput({
    ...
    this.fieldStyle = OTPStyle.underline,
    this.onChanged,
    this.inputFormatter,
    this.contentPadding =
...
class _AppOTPInputState extends State<AppOTPInput> {
  late AppOTPInputStyle _otpFieldStyle;
  ...
  void initState() {
    ...
    if (widget.otpFieldStyle == null) {
      _otpFieldStyle = AppOTPInputStyle();
    } else {
  ...
  Widget buildTextField(BuildContext context, int index) {
    ...
    InputBorder _getBorder(Color color) {
      ...
      return widget.fieldStyle == OTPStyle.box
          ? OutlineInputBorder(
...
class OtpFieldController {
  late _AppOTPInputState _otpTextFieldState;

  // ignore: library_private_types_in_public_api
  void setOtpTextFieldState(_AppOTPInputState state) {
