...
showKindSheet(BuildContext context, List<String> entries) {
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        color: AppColors().getProp("${entries[index]}BadgeBg"),
                      ),
                      height: 50,
                      child: Center(
                        child: Container(
                          ...
                          height:
                              sheetHeight - AppSizes.pageHorizontalMargin * 5,
                          width: MediaQuery.of(context).size.width,
                          decoration: const BoxDecoration(
                          ...
                          child: Text(
                            AppHelper().capitalize(entries[index]),
